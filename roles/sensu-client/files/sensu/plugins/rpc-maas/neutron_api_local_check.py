...
def check(args):
    ...
    # Any other exception presumably isn't an API error
        ...
        ports = len(neutron.list_ports()['ports'])
        floatingips = len(neutron.list_floatingips()['floatingips'])
    ...
    if is_up:
        ...
        metric('neutron_ports', 'uint32', ports, 'ports')
        metric('neutron_floatingips', 'uint32', floatingips, 'floatingips')
