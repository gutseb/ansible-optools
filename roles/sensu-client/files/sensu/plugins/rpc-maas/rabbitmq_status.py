...
#CLUSTERED = True	# Added to configurable parameter
CLUSTER_SIZE = 3
...
def parse_args():
    ...
    parser.add_option('-c', '--clustered', action='store', dest='clustered',
                      default='True',
                      help='True if RabbitMQ is clustered')
...
def main():
    ...
    metrics = {}
    # Added configurable cluster check
