...
These plugins come from RackSpace Monitoring as a Service at the below source: 
https://github.com/rcbops/rpc-maas

They have been slightly modified to be used as metrics checks with Sensu.  In addition, a few checks have been where functionality was missing
