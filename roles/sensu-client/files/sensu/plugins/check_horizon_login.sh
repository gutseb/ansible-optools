#!/bin/bash
#
# Horizon Dashboard Login monitoring script for Sensu / Nagios
#
...
while getopts 'hH:f:U:P:E:c' OPTION
do
    case $OPTION in
        h)
            usage
...
CFILENAME="/tmp/check_horizon_cookieFile_$(whoami)"
COOKIE_FILE=${COOKIE_FILE:-"$CFILENAME"}
